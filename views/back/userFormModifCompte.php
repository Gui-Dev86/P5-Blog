        ...
        <div class="container col-12 col-md-8 offset-md-2 pb-5">
            <form method="post" action="POST">
                <div class="form-group">
                    ...
                    <input type="texte" name="newLogin" class="form-control" id="newLogin" placeholder="session.login">
                </div>
                <div class="form-group">
                    <label for="newFistname">Prénom</label>
                    <input type="texte" name="newFistname" class="form-control" id="newFistname" placeholder="session.Fistname">
                </div>
                <div class="form-group">
                    <label for="newLasname">Nom</label>
                    <input type="texte" name="newLasname" class="form-control" id="newLasname" placeholder="session.Lasname">
                </div>
                <div class="form-group">
                    <label for="email">Adresse email</label>
                    <input type="email" name="email" class="form-control" id="email" placeholder="session.email">
                </div>
